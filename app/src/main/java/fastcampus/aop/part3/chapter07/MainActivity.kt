...
class MainActivity : ComponentActivity(), OnMapReadyCallback, Overlay.OnClickListener {
    ...
    private fun updateMarker(houses: List<HouseModel>) {
        houses.forEach { house ->
            ...
            // 마커의 onclickListener를 Overlay의 OnClickListener를 구현함
